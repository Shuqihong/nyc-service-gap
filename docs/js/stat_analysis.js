...
(function () {
  ...
  const data = [
    ...
    { name: "+ borough + month",     r2: 0.007, phone: null  },
    { name: "+ filing channel",      r2: 0.127, phone: 1.80  },
    { name: "+ city agency",         r2: 0.667, phone: 0.06  },
    { name: "+ complaint type",      r2: 0.792, phone: -0.01 },
  ];
  ...
  svg.append("text").attr("x", W / 2).attr("y", 22).attr("text-anchor", "middle")
    .style("font-size", "14px").style("font-weight", "bold").style("fill", "#222")
    .text("Nested regression: variance explained & how the phone effect collapses");
